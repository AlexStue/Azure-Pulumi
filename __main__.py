...
# ------------------------------------------------------------------
    ...
    #     region_az_subnet_public        = infra_az.create_subnet_public(region, resource_group, region_vnet, az)
    #     region_az_subnet_private       = infra_az.create_subnet_private(region, resource_group, region_vnet, az)
    #     region_az_subnet_asso_public   = infra_az.associate_subnet_public_with_security_group(region, region_az_subnet_public, region_nsg, az)
    #     region_az_subnet_asso_private  = infra_az.associate_subnet_private_with_security_group(region, region_az_subnet_private, region_nsg, az)
        ...
        # region_az_nat_asso_sb   = infra_az.associate_nat_gateway_with_subnet(region, region_az_subnet_public, region_az_nat_gateway, az)
        ...
        # region_az_asso_public   = infra_az.associate_route_table_with_private_subnet(region, region_az_subnet_private, region_az_rt_private, az)
